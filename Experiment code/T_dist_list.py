         ...
         if not node.is_leaf():
            ...
            for node in t2.traverse("levelorder"):
              if not node.is_leaf():
                ...
                trips=list_def(trips,subtree1_blue, subtree2_red)
                trips=list_def(trips,subtree2_blue, subtree1_red)
                trips=list_def(trips,subtree1_red,subtree2_blue)
                trips=list_def(trips,subtree2_red, subtree1_blue)
